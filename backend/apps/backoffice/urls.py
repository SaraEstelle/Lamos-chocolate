...
urlpatterns = [
    ...
    path(
        ...
        views.order_update_status_view,
        name="order_status",
    ),
    ...
    path(
        "b2b/<int:request_id>/status/", views.b2b_update_status_view, name="b2b_status"
    ),
    ...
    path(
        "b2b-accounts/<uuid:account_id>/decision/",
        views.b2b_account_decision_view,
        name="b2b_account_decision",
    ),
]
